...
| Image                   | ImageFill                  | boolean                             | false                                          | Whether landscape images and split-view portrait images should fill available space. Aspect ratio is maintained but may be cropped.    |
...
| UI                      | Layout                     | single \| splitview                 | splitview                                      | Allows two portrait images to be displayed next to each other. Landscape images are displayed in single view. Portrait images are not shown as single slides. |
